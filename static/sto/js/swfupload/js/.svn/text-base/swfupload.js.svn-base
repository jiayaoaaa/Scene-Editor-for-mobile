...
SWFUpload.prototype.getFlashHTML = function () {
	...
	return ['<object style="',this.settings.css_style,'" id="', this.movieName, '" type="application/x-shockwave-flash" data="', this.settings.flash_url, '" width="', this.settings.button_width, '" height="', this.settings.button_height, '" class="swfupload">',
