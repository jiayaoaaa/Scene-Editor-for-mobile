...
define(['avalon','draggable', 
        'text!'+SP_URL_STO+'vendor/avalon/slider/avalon.slider.tpl', //text 必须用绝对地址草泥马
        'css!vendor/avalon/oniui-common.css', 
        'css!vendor/avalon/slider/avalon.slider.css', 
        'vendor/avalon/avalon.getModel'], function(avalon, draggable,sourceHTML) {
    /**
    ...
    var widget = avalon.ui["slider"] = function(element, data, vmodels) {
        ...
        // 修正模板
        var sliderHTML = options.template.replace(/MS_OPTION_WIDTHORHEIGHT/ig, isHorizontal? "width": "height").replace(/MS_OPTION_LEFTORBOTTOM/ig, isHorizontal? "left" : "bottom");
