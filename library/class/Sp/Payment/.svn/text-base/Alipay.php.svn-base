...
class Sp_Payment_Alipay extends Sp_Payment
{
	/**
	 * 准备支付，如准备页面、表单等信息
	 * 
	...
	public function prepare($params)
	{
		...
		#调用签名函数生成签名串
		$hmac = Sp_Payment_Alipay_Common::getReqHmacString($p2_Order,$p3_Amt,$p4_Cur,$p5_Pid,$p6_Pcat,$p7_Pdesc,$p8_Url,$pa_MP,$pd_FrpId,$pr_NeedResponse);
		$p0_Cmd = Sp_Payment_Alipay_Common::$p0_Cmd;
		$p9_SAF = Sp_Payment_Alipay_Common::$p9_SAF;
		header('Content-Type: text/html; charset=gb2312');
		$rel = '<html><body onLoad="document.Alipay.submit();">';
		$rel .= '<form name="Alipay" action="'.$reqURL_onLine.'" method="post">';
	...
	public function complete($params)
	{
		$view = new Sp_View;
		#	解析返回参数.
		$return = Sp_Payment_Alipay_Common::getCallBackValue($r0_Cmd,$r1_Code,$r2_TrxId,$r3_Amt,$r4_Cur,$r5_Pid,$r6_Order,$r7_Uid,$r8_MP,$r9_BType,$hmac);

		#	判断返回签名是否正确（True/False）
		$bRet = Sp_Payment_Alipay_Common::CheckHmac($r0_Cmd,$r1_Code,$r2_TrxId,$r3_Amt,$r4_Cur,$r5_Pid,$r6_Order,$r7_Uid,$r8_MP,$r9_BType,$hmac);
		#	以上代码和变量不需要修改.
