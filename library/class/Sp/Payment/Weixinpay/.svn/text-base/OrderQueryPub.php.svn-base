 ...
 * 订单查询接口
 */
class Sp_Payment_Weixinpay_OrderQueryPub extends Sp_Payment_Weixinpay_WxpayClientPub
{
	...
	function createXml()
	{
		try
		{
			...
			{
				throw new Sp_Payment_Weixinpay_SDKRuntimeException("订单查询接口中，out_trade_no、transaction_id至少填一个！"."<br>");
			}
