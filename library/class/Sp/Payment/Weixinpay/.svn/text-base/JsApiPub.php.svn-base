...
* JSAPI支付——H5网页端调起支付接口
*/
class Sp_Payment_Weixinpay_JsApiPub extends Sp_Payment_Weixinpay_Commonutilpub
{
	...
	function createOauthUrlForCode($redirectUrl)
	{
		...
		$urlObj["appid"] = $_settings['weixinpay']['virCardNoIn'];//公众账号ID
	...
	{
		$_settings = Loader::config('pay');
		$jsApiObj["appId"] = $_settings['weixinpay']['virCardNoIn'];//公众账号ID
		$timeStamp = time();
