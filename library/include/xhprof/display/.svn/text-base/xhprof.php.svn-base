 ...
 *
 */
function xhprof_include_js_css() {

  // style sheets
  echo "<link href='".SP_URL_CSS."xhprof.css' rel='stylesheet' ".
    " type='text/css'></link>";
  echo "<link href='".SP_URL_CSS."jquery.tooltip.css' ".
    " rel='stylesheet' type='text/css'></link>";
  echo "<link href='".SP_URL_CSS."jquery.autocomplete.css' ".
    " rel='stylesheet' type='text/css'></link>";

  // javascript
  echo "<script src='".SP_URL_JS."jquery-1.3.2.js'>".
       "</script>";
  echo "<script src='".SP_URL_JS."jquery.tooltip.js'>".
       "</script>";
  echo "<script src='".SP_URL_JS."jquery.autocomplete.js'>"
       ."</script>";
  echo "<script src='".SP_URL_JS."xhprof_report.js'></script>";
}
